...
/* ─── Lerp ──────────────────────────────────────────────── */
const LERP_MAIN  = 0.14; // shape principale — précis
const LERP_TRAIL = 0.08; // glow rouge — traîne organique

/* ─── Easings ───────────────────────────────────────────── */
const E      = [0.25, 0.46, 0.45, 0.94] as const; // smooth decel
const E_TEXT = [0.22, 1,    0.36, 1   ] as const; // expo-out
...
/* ═══════════════════════════════════════════════════════════
   ÉTAT GLOBAL
   · _explicit : contrôlé par les composants (project / default)
   · _autoHover: auto-détecté via event delegation
   · L'état projet prime sur hover
═══════════════════════════════════════════════════════════ */
...
export function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      ...
      /* Auto-détection hover sur éléments interactifs
         (n'interfère jamais avec l'état "project") */
    ...
    <>
      ...
      >
        <motion.div
          ...
          style={{
            /* Centrage auto : translate -50% -50% suit
               n'importe quelle width/height animée */
            ...
            overflow: "hidden",
            /* Petit halo rouge intégré à la shape — très subtil */
            boxShadow:
              state === "project"
        ...
        >
          ...
          >
            ...
            >
              <svg
                ...
                style={{
                  overflow: "visible",
                  filter: "drop-shadow(0 0 2px rgba(94,10,27,0.08))",
                }}
              >
                <path
                  d={SITE_STAR_PATH}
                  fill="url(#cursor-site-star-back-fill)"
                  stroke="rgba(255,255,255,0.08)"
                  strokeWidth="0.3"
                />
                <path
                  d="M13 2L15.7 10.3L13 13L10.3 10.3L13 2Z"
                  fill="rgba(255,255,255,0.05)"
                />
                <path
                  d="M10.3 15.7L13 24L15.7 15.7L13 13L10.3 15.7Z"
                  fill="rgba(49,4,14,0.30)"
                />
              </svg>
            </div>
            ...
            >
              <div
                style={{
                  ...
                  transformStyle: "preserve-3d",
                  clipPath:
                    "polygon(50% 0%, 86% 16%, 100% 50%, 86% 84%, 50% 100%, 14% 84%, 0% 50%, 14% 16%)",
                  background:
                    "linear-gradient(180deg, rgba(255,255,255,0.18) 0%, rgba(252,86,115,0.58) 18%, rgba(188,24,52,0.78) 48%, rgba(108,12,30,0.88) 100%)",
                  borderLeft: "1px solid rgba(255,255,255,0.07)",
                  borderRight: "1px solid rgba(255,255,255,0.04)",
                  boxShadow:
                    "inset 0 0 4px rgba(255,255,255,0.08), inset 0 -2px 3px rgba(51,4,15,0.25)",
                  opacity: 0.95,
                }}
              />
            </div>
            ...
            <motion.svg
              ...
              style={{
                overflow: "visible",
                filter: "drop-shadow(0 0 4px rgba(252,18,53,0.14))",
              }}
            >
              <defs>
              ...
              <path
                d={SITE_STAR_PATH}
                fill="url(#cursor-site-star-fill)"
              ...
              />
              <path
                d="M15.7 10.3L24 13L15.7 15.7L13 13L15.7 10.3Z"
                fill="rgba(255,196,214,0.18)"
              />
              <path
                d="M10.3 15.7L13 24L15.7 15.7L13 13L10.3 15.7Z"
                fill="rgba(92,8,24,0.28)"
              />
              <path
                d={SITE_STAR_PATH}
                fill="url(#cursor-site-star-core)"
              />
              <path
                d={SITE_STAR_PATH}
                fill="url(#cursor-site-star-inner-shadow)"
              />
              <path
                d={SITE_STAR_PATH}
                fill="none"
                stroke="url(#cursor-site-star-bevel)"
                strokeWidth="0.48"
              />
              <path
                d={SITE_STAR_PATH}
          ...
          >
            ...
            {/* Mini-bouton flèche rouge — UI element, pas sticker */}
            <span
              style={{
                display: "inline-flex",
                alignItems: "center",
